...
class Report(Base):
    ...
    # Section 3A: Health Data - General Attendance
    health_general_attendance_total = Column(Integer, default=0)

    # Section 3A: Health Data - OPD Immunization
    health_opd_total = Column(Integer, default=0)
    health_routine_immunization_total = Column(Integer, default=0)
    ...
    health_opd_under5_total = Column(Integer, default=0)  # Legacy - kept for backward compat
    ...
    # Section 3B: Health Facility Support - Renovations (new structure)
    facility_renovated = Column(String(10), nullable=True)  # Yes/No
    facility_renovated_count = Column(Integer, default=0)
    facility_renovations = Column(Text, nullable=True)  # JSON array [{facility_name, partner}]

    # Section 3B: Legacy renovation fields (kept for backward compat)
    ...
    awareness_theme = Column(Text, nullable=True)  # Legacy - kept for backward compat
    awareness_topic = Column(Text, nullable=True)  # New field name
    traditional_leaders_support = Column(Text, nullable=True)
    religious_leaders_support = Column(Text, nullable=True)
