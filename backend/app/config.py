...
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = 60 * 24  # 24 hours - users should never be interrupted
REFRESH_TOKEN_EXPIRE_DAYS = 365  # 1 year - effectively never expires
...
ALLOWED_AUDIO_EXTENSIONS = {".mp3", ".m4a", ".wav", ".ogg", ".webm", ".mp4", ".mov"}
