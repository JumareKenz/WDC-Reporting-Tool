 ...
 */
const SessionWarningModal = ({ isOpen, countdown, onContinue, onLogout, isExtended = false }) => {
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 animate-scale-in">
        ...
        >
          ...
          {isExtended && (
            <span className="block text-sm font-normal text-primary-600 mt-1">
              (Extended due to form activity)
            </span>
          )}
        </h2>
