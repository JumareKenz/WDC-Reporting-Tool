 ...
 * PWAInstallPrompt
 *
 * Shows a native-style "Add to Home Screen" prompt on web browsers.
 * Automatically hidden inside Capacitor native builds — the app is already
 * installed as a native APK, so this prompt is irrelevant and would confuse
 * users.
 */
...
const PWAInstallPrompt = () => {
  // In a native Capacitor shell, render nothing at all
      ...
      <div className="m-3 max-w-md mx-auto bg-white rounded-xl shadow-xl border border-neutral-200 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-neutral-900 text-sm">Add to Home Screen</p>
